...
<script>foo</script>");
        ...
        //{
        //    Candy.HtmlDocument.MaxDepthLevel = 10;
        //    var doc = GetMshomeDocument();
        //    try
        //    {
        //        Assert.IsTrue(doc.DocumentNode.Descendants().Count() > 0);
        ...
        //    {
        //        Assert.IsTrue(e.Message == Candy.HtmlNode.DepthLevelExceptionMessage);
        //    }
        //    Candy.HtmlDocument.MaxDepthLevel = int.MaxValue;
        //}
        ...
        public void TestCopyFromNode()
        {
            ...
            var newNode = Candy.HtmlNode.CreateNode("<body></body>");
...
<h1>This is <b>bold</b> headddding</h1>
	...
	<h2>This is <i>italic</i> heading</h2>
        ...
        //    var docLoad = new Candy.HtmlWeb().Load(url);
...
<body>
	...
	<h2>This is new heading</h2>
        ...
        public void TestLoadWithUri()
        {
            ...
            //var web = new HtmlWeb();
            //Candy.HtmlDocument document = web.Load(uri);
